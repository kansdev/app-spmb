...
<section id="beranda" class="hero text-center">
  <div class="container">
    ...
    <p class="lead">Jl. Cisadane V, RT.003/RW.002, Nusa Jaya, Kec. Karawaci, Kota Tangerang, Banten 15116</p>
        ...
        <div class="p-3 p-md-5">
          ...
          <div class="tab-scroll-wrapper">
              <ul class="nav nav-underline nav-scroll" id="informasiTab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="javascript:void(0)" id="persyaratan-tab" data-bs-toggle="tab" data-bs-target="#persyaratan-tab-pane" type="button" role="tab" aria-controls="persyaratan-tab-pane" aria-selected="true">Persyaratan</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript:void(0)" id="tata-cara-tab" data-bs-toggle="tab" data-bs-target="#tata-cara-tab-pane" type="button" role="tab" aria-controls="tata-cara-tab-pane" aria-selected="true">Tata Cara</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="javascript:void(0)" id="pendaftaran-reguler-tab" data-bs-toggle="tab" data-bs-target="#pendaftaran-reguler-tab-pane" type="button" role="tab" aria-controls="pendaftaran-reguler-tab-pane" aria-selected="true">Pendaftaran Reguler</a>
                </li>
              </ul>
          </div>
