        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    <tr>
                        <th>Nilai Rata-Rata Raport Semester 1</th>
                        <td>{{ $nilai_raport->nilai_raport_semester_1 }}</td>
                    </tr>
                    <tr>
                        <th>Nilai Rata-Rata Raport Semester 2</th>
                        <td>{{ $nilai_raport->nilai_raport_semester_2 }}</td>
                    </tr>
                    <tr>
                        <th>Nilai Rata-Rata Raport Semester 3</th>
                        <td>{{ $nilai_raport->nilai_raport_semester_3 }}</td>
                    </tr>
                    <tr>
                        <th>Nilai Rata-Rata Raport Semester 4</th>
                        <td>{{ $nilai_raport->nilai_raport_semester_4 }}</td>
                    </tr>
                    <tr>
                        <th>Nilai Rata-Rata Raport Semester 5</th>
