                ...
                <form action="{{ route('save_formulir_registrasi') }}" method="post">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="gelombang_sesi" id="gelombang-sesi">
                            <option value="">--- Pilih ---</option>
                            <option value="28 Maret 2026" {{ old('gelombang_sesi') == '28 Maret 2026' ? 'selected' : '' }}>Sabtu, 28 Maret 2026</option>
                            <option value="29 Maret 2026" {{ old('gelombang_sesi') == '29 Maret 2026' ? 'selected' : '' }}>Minggu, 29 Maret 2026</option>
                        </select>
                    </div>
